...
public class CameraView {
    ...
    public final static int STATE_CAMERA_ENABLE = 1;
    public final static int STATE_CAMERA_DISABLE = 0;
    ...
    public CameraView(AutoFitTextureView textureView) {
     ...
     *
     * @param activity
     * @return 相机是否可用 1:可用，0：不可用
     */
    public int initCamera(Activity activity, int width, int height) {
        this.activity = activity;
        CameraManager manager = (CameraManager) activity.getSystemService(Context.CAMERA_SERVICE);
        if (manager == null) {
            return STATE_CAMERA_DISABLE;
        }
        try {
            cameraThread.start();
            for (String cameraId : manager.getCameraIdList()) {
                ...
                mImageReader.setOnImageAvailableListener(
                        mOnImageAvailableListener, cameraThread.getHandler());
    ...
    public void start(Context context) {
        ...
        try {
            manager.openCamera(mCameraId, mStateCallback, cameraThread.getHandler());
        } catch (CameraAccessException e) {
            e.printStackTrace();
        }
    }
     ...
     * 选择最优的预览尺寸
     *
     * @param choices           系统支持的相机尺寸列表
     * @param textureViewWidth  预览容器宽度
     * @param textureViewHeight 预览容器高度
     * @param aspectRatio       最大的尺寸
     * @return
     */
    private Size chooseOptimalSize(Size[] choices, int textureViewWidth,
        ...
        float bili = textureViewWidth / (float) textureViewHeight;
        for (Size option : choices) {
            float optionBili = option.getHeight() / (float) option.getWidth();
                        ...
                        public void onConfigured(@NonNull CameraCaptureSession cameraCaptureSession) {
                            ...
                            try {
                                ...
                                mCaptureSession.setRepeatingRequest(mPreviewRequest,
                                        mCaptureCallback, cameraThread.getHandler());
                            } catch (CameraAccessException e) {
                                e.printStackTrace();
                            }
                        }
    ...
    private ImageReader.OnImageAvailableListener mOnImageAvailableListener = new ImageReader.OnImageAvailableListener() {
        ...
        public void onImageAvailable(final ImageReader reader) {
            cameraThread.getHandler().post(new Runnable() {
                @Override
                public void run() {
                    ...
                    File dir = pictureTakenListener.getTargetDir();
                    if (dir == null) {
                        return;
                    }
                    ...
                    try {
                        ...
                        output.write(bytes);
                        pictureTakenListener.onPictureTaken(file);
                    } catch (IOException e) {
                        e.printStackTrace();
                    } finally {
                        image.close();
